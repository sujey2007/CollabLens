  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.groupLabel}>Quick Feature Hub</Text>
        <View style={styles.featureGrid}>
          <TouchableOpacity style={styles.featureCard} onPress={() => router.push('/features/search-filter')}>
            <View style={[styles.featureIconBox, { backgroundColor: 'rgba(0, 229, 255, 0.1)' }]}>
              <Ionicons name="search" size={18} color="#00E5FF" />
            </View>
            <Text style={styles.featureCardTitle} numberOfLines={1}>Search & Filter</Text>
            <Text style={styles.featureCardSub} numberOfLines={1}>Open screen</Text>
          </TouchableOpacity>

          <TouchableOpacity style={styles.featureCard} onPress={() => router.push('/features/health-score')}>
            <View style={[styles.featureIconBox, { backgroundColor: 'rgba(0, 230, 118, 0.1)' }]}>
              <MaterialCommunityIcons name="pulse" size={18} color="#00E676" />
            </View>
            <Text style={styles.featureCardTitle} numberOfLines={1}>Health Score</Text>
            <Text style={styles.featureCardSub} numberOfLines={1}>{globalHealthScore}% efficiency</Text>
          </TouchableOpacity>

          <TouchableOpacity style={styles.featureCard} onPress={() => router.push('/features/velocity-analytics')}>
            <View style={[styles.featureIconBox, { backgroundColor: 'rgba(0, 229, 255, 0.15)' }]}>
              <MaterialCommunityIcons name="chart-line" size={18} color="#00E5FF" />
            </View>
            <Text style={styles.featureCardTitle} numberOfLines={1}>Velocity Graph</Text>
            <Text style={styles.featureCardSub} numberOfLines={1}>Analytics</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.sectionHeader}>
          ...
          <TouchableOpacity onPress={() => router.push('/features/velocity-analytics')}>
            <Text style={styles.seeAllText}>View Analytics Graphs →</Text>
          </TouchableOpacity>
        </View>
...
const styles = StyleSheet.create({
  ...
  groupLabel: { fontSize: 13, fontWeight: '700', color: '#8A99AD', marginBottom: 10, textTransform: 'uppercase', letterSpacing: 0.5 },
  featureGrid: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 20 },
  featureCard: { flex: 1, backgroundColor: '#131C2E', borderRadius: 14, paddingVertical: 10, paddingHorizontal: 4, marginHorizontal: 3, alignItems: 'center', borderWidth: 1, borderColor: 'rgba(255, 255, 255, 0.08)' },
  featureIconBox: { width: 32, height: 32, borderRadius: 8, justifyContent: 'center', alignItems: 'center', marginBottom: 6 },
  featureCardTitle: { fontSize: 10, fontWeight: '700', color: '#FFFFFF', marginBottom: 2, textAlign: 'center' },
  featureCardSub: { fontSize: 8, color: '#8A99AD', textAlign: 'center' },
